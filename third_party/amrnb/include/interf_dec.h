 ...
 */
extern __declspec(dllexport) void Decoder_Interface_Decode( void *st,
 ...
 */
extern __declspec(dllexport) void *Decoder_Interface_init( void );

/*
 * Exit and free memory
 */
extern __declspec(dllexport) void Decoder_Interface_exit( void *state );
