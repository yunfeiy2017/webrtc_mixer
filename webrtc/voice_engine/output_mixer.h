...
public:
	...
	int DeRegisterExternalStreamReceiver();
	...
	WebRtc_Word32 RegisterMixerModule(AudioConferenceMixer *mixer);
...
private:
	...
	StreamReceiver* _externalStreamReceiverPtr;
    bool _externalMedia;
	bool _externalStreamReceiver;
    float _panLeft;
    float _panRight;
