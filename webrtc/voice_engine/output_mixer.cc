...
WebRtc_Word32
OutputMixer::RegisterMixerModule(AudioConferenceMixer *mixer)
{
	delete &_mixerModule;
	_mixerModule = *mixer;
	return 0;
...
OutputMixer::OutputMixer(const WebRtc_UWord32 instanceId) :
	...
	_externalStreamReceiverPtr(NULL),
	_externalStreamReceiver(false),
    _panLeft(1.0f),
    _panRight(1.0f),
...
OutputMixer::~OutputMixer()
{
	...
	if (_externalStreamReceiver)
	{
		DeRegisterExternalStreamReceiver();
	}
    {
        CriticalSectionScoped cs(&_fileCritSect);
...
int OutputMixer::RegisterExternalStreamReceiver(StreamReceiver & receiver)
{
	CriticalSectionScoped cs(&_callbackCritSect);
	_externalStreamReceiverPtr = &receiver;
	_externalStreamReceiver = true;
	return 0;
}

int OutputMixer::DeRegisterExternalStreamReceiver()
{
	CriticalSectionScoped cs(&_callbackCritSect);
	_externalStreamReceiver = false;
	_externalStreamReceiverPtr = NULL;
