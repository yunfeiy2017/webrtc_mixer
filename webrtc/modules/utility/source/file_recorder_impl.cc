...
{
    return 3 * _videoCodecInst.width_used * _videoCodecInst.height_used / 2;
}
...
WebRtc_Word32 AviRecorder::EncodeAndWriteVideoToFile(I420VideoFrame& videoFrame)
{
    ...
    if(_frameScaler->ResizeFrameIfNeeded(&videoFrame, _videoCodecInst.width_used,
                                         _videoCodecInst.height_used) != 0)
    {
        return -1;
    }
