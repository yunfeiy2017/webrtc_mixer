...
public:
    ...
    struct SpeakerLineInfo
    {
		...
		//2013.7.18 add wave volume control
		DWORD dwWaveLineID;
		bool  waveIsValid;
		DWORD dwWaveVolumeControlID;
		bool  waveVolumeControlIsValid;
		DWORD dwWaveMuteControlID;
		bool  waveMuteControlIsValid;
    };
...
private:
	...
	bool GetWaveOutLineInfo(UINT mixId, DWORD destId, MIXERLINE& line, bool trace = false) const;
