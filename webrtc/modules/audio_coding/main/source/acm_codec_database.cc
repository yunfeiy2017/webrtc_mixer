...
# endif
  ...
  // Stereo
  {121, "PCMU", 8000, 160, 2, 64000},
  {118, "PCMA", 8000, 160, 2, 64000},
#ifdef WEBRTC_CODEC_ILBC
 // {102, "ILBC", 8000, 240, 1, 13300},
  {102, "ILBC", 8000, 320, 1, 15200},
#endif
#ifdef WEBRTC_CODEC_AMR
  {122, "AMR", 8000, 320, 1, 12200},
#endif
#ifdef WEBRTC_CODEC_AMRWB
  {kDynamicPayloadtypes[count_database++], "AMR-WB", 16000, 640, 1, 20000},
#endif
#ifdef WEBRTC_CODEC_CELT
  // Mono
  ...
  {120, "opus", 48000, 1920, 1, 24000},
#endif
#ifdef WEBRTC_CODEC_SPEEX
  {kDynamicPayloadtypes[count_database++], "speex", 8000, 320, 1, 11000},
  {110, "speex", 16000, 640, 1, 22000},
  {kDynamicPayloadtypes[count_database++], "speex", 32000, 960, 1, 64000},
#endif
