...
// External mixer stream callback interface
...
class ExternDecodedFrameInterfaceBase
{
public:
	virtual  void  DecodedDataCallback(void * YBuf,void * Ubuf,void *Vbuf, int width, int height){};
};
